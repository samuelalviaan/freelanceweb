                        ...
                        <form action="{{ route('member.service.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="">
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Total Harga Service Kamu" type="number" name="price"
                                                ...
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('price') }}" required>
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Thumbnail 1" type="file" name="thumbnail[]"
                                                id="thumbnail-service" autocomplete="thumbnail-service"
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Keunggulan 1" type="text" name="advantage-user[]"
                                                ...
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('advantage-user[]') }}">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input placeholder="Hal yang ingin disampaikan oleh kamu?" type="text"
                                                ...
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" value="{{ old('note') }}">
                                ...
                                <div class="px-4 py-3 text-right sm:px-6">
                                    ...
                                    <button type="submit"
                                        class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-lg shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" onclick="return confirm('Are you sure wanna save this data?')">
                                        Create Service
                                    </button>
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        $("#addTaglineRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Tagline" type="text" name="tagline[]" id="tagline" autocomplete="tagline" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
    ...
    <script type="text/javascript">
        ...
        $("#addThumbnailRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Thumbnail " type="file" name="thumbnail[]" id="thumbnail-service" autocomplete="thumbnail-service" class="block w-full py-3 pl-5 mt-1 border border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm" required>';
